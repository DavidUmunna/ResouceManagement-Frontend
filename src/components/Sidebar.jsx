...
const Sidebar=forwardRef(({ isOpen, onClose },ref) =>{
  ...
  const sidebar = [
    ...
    { name:"Tenders" ,to:"/admin/tenders", icon:Briefcase, visibleTo:["global_admin","Contracts_manager","Business_development","procurement_officer"]},
    { name:"File Tracking", to:"/admin/filetracking",icon:FileSearch, visibleTo:["Contracts_manager","global_admin"]},
    { name:"AI Tools", to:"/admin/ai-tools", icon:Brain, visibleTo:["global_admin","Contracts_manager"]},
